import random
# modified the Deck class to shuffle the deck in the constructor
...
class Deck:
    ...
    def __init__(self):
        ...
        random.shuffle(self.cards) # Remove the shuffleDeck method and make it a part of the constructor
